...
//    @Transactional
//    @Modifying
//    @Query(value = "delete from gearvn.cart_user where id_product = :id_product and id_user = :id_user", nativeQuery = true)
//    void deleteItem (@Param("id_product") int id_product, @Param("id_user") int id_user);
}
