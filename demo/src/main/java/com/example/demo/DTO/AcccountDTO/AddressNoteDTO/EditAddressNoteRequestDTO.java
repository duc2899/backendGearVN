...
public class EditAddressNoteRequestDTO {
    @NotNull
    private int idUser;
    @NotNull
    private int idAddressNote;
    @NotNull
    ...
    public int getIdAddressNote() {
        return idAddressNote;
    }

    public void setIdAddressNote(int idAddressNote) {
        this.idAddressNote = idAddressNote;
    }
